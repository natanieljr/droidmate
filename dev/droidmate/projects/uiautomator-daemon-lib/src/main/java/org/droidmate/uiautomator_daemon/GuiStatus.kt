        ...
        private fun createWidget(n: Node, parentWidget: WidgetData?): WidgetData? {
            try {
                ...
                return WidgetData(mapOf(
                        ...
                        WidgetData::checked.name to getBool("checked"),
                        WidgetData::checkable.name to getBool("checkable"),
                        WidgetData::clickable.name to getBool("clickable"),
                        WidgetData::enabled.name to getBool("enabled"),
                        WidgetData::focused.name to getBool("focused"),
                        WidgetData::focusable.name to getBool("focusable"),
