...
"""
        ...
        Assert.assertEquals(msg.replaceAll("\\\\'","'"), payload)
    }
...
"""
    ...
    @Test
    void "Parses escaped quoted value"() {
        String msg = """\
