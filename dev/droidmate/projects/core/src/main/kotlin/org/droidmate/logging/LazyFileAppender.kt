...
public class LazyFileAppender<E> : OutputStreamAppender<E>() {
     ...
     */
    public fun rawFileProperty(): String
            = fileName
     ...
     */
    @Throws(IOException::class) private fun openFile(filename: String): Boolean {
