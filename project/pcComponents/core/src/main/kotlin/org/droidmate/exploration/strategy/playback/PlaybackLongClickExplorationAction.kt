...
class PlaybackLongClickExplorationAction(widget: Widget, private val metaText: String = "") : LongClickExplorationAction(widget,	useCoordinates = true) { // FIXME some meta-data missing like longClick or swipe
