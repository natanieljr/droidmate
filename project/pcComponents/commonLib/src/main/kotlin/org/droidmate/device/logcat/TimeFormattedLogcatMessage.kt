...
class TimeFormattedLogcatMessage private constructor(override val time: LocalDateTime,
                                                     ...
                                                     override val messagePayload: String) : TimeFormattedLogMessageI {
	companion object {
		...
		@JvmStatic
		fun from(time: LocalDateTime, level: String, tag: String, pidString: String, messagePayload: String): TimeFormattedLogMessageI = TimeFormattedLogcatMessage(time, level, tag, pidString, messagePayload)
