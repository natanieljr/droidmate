...
class TimeFormattedLogcatMessage private constructor(override val time: LocalDateTime,
	...
	companion object {
		...
		@JvmStatic
		fun from(time: LocalDateTime, level: String, tag: String, pidString: String, messagePayload: String): ITimeFormattedLogcatMessage = TimeFormattedLogcatMessage(time, level, tag, pidString, messagePayload)
